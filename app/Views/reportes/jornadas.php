...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Reportes estadísticos | Jornadas</h1>
                        ...
                        <div class="card-body">
                            <form id="form-reporte" novalidate>
                                <div class="row g-3">
                                    ...
                                    <div id="estadod" class="col-md-3 mb-3">
                    ...
                    <div id="contenedor_general" style="display: none;">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-xl-6 col-lg-6 mb-4 wrapper-chart" id="wrapper-chartT">
                                        <div class="card h-100">
                                            <div class="card-header py-2 text-center small font-weight-bold">Distribución por Tipo</div>
                                            <div class="card-body"><canvas id="chartT"></canvas></div>
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-lg-6 mb-4 wrapper-chart" id="wrapper-chartU">
                                        <div class="card h-100">
                                            <div class="card-header py-2 text-center small font-weight-bold">Distribución por Ubicación</div>
                                            <div class="card-body"><canvas id="chartU"></canvas></div>
                                        </div>
                                    </div>
                                    <div class="col-xl-12 col-lg-12 mb-4 wrapper-chart" id="wrapper-chartE">
                                        <div class="card h-100">
                                            <div class="card-header py-2 text-center small font-weight-bold">Distribución por Estado</div>
    ...
    <script src="<?= BASE_URL ?>dist/js/modulos/reportes/jornadas.js"></script>
</body>
