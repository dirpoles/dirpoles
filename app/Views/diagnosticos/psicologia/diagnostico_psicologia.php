            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="<?= BASE_URL ?>diagnostico_psicologia_consultar"
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card shadow mb-4 border-left-primary">
                                ...
                                <div class="card-body">
                                    <form action="<?= BASE_URL ?>diagnostico_psicologia_registrar" method="POST"
                                        id="form-diagnostico-general" class="needs-validation" novalidate>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <select name="id_patologia" id="id_patologia"
                                                        class="form-select select2">
                                                        <option value="" selected disabled>Seleccione una patología
                                                        </option>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" id="diagnostico" name="diagnostico"
                                                        rows="4"
                                                        placeholder="Describa el diagnóstico psicológico..."></textarea>
                                                    <div class="invalid-feedback" id="diagnosticoError"></div>
                                                    <small class="form-text text-muted">
                                                        Incluya observaciones sobre el estado mental, emocional y
                                                        conductual
                                                    </small>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <h6 class="text-primary mb-3">
                                                    <i class="fas fa-clipboard-list me-2"></i>Observaciones y
                                                    Recomendaciones
                                                </h6>
                                                <div class="mb-3">
                                                    <label for="observaciones_diagnostico"
                                                        class="form-label">Observaciones Finales</label>
                                                    <textarea class="form-control" id="observaciones_diagnostico"
                                                        name="observaciones" rows="3"
                                                        placeholder="Observaciones adicionales, recomendaciones, pronóstico..."></textarea>
                                                    <small class="form-text text-muted">
                                                        Notas adicionales, seguimiento recomendado, observaciones del
                                                        psicólogo
                                                    </small>
                                                    <div class="invalid-feedback" id="observaciones_diagnosticoError">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" id="tratamiento_gen"
                                                        name="tratamiento_gen" rows="3"
                                                        placeholder="Describa el tratamiento general recomendado..."></textarea>
                                                    <small class="form-text text-muted">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            <div class="card shadow h-100 border-left-warning">
                                ...
                                <div class="card-body d-flex flex-column">
                                    <form action="<?= BASE_URL ?>registrar_retiro_temporal" method="POST"
                                        id="form-retiro-temporal" class="needs-validation d-flex flex-column h-100"
                                        novalidate>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select class="form-select" id="motivo_retiro" name="motivo_retiro">
                                                    ...
                                                    <option value="Problemas personales/familiares">Problemas
                                                        personales/familiares</option>
                                            ...
                                            <div class="col-12 mb-3" id="otro-motivo-container" style="display: none;">
                                                ...
                                                <input type="text" class="form-control" id="motivo_retiro_otro"
                                            ...
                                            <div class="col-12 mb-3">
                                                <label for="observaciones_retiro"
                                                    class="form-label">Observaciones</label>
                                                <textarea class="form-control" id="observaciones_retiro"
                                                    name="observaciones_retiro" rows="3"
                                                    placeholder="Observaciones sobre el retiro temporal..."></textarea>
                                                <small class="form-text text-muted">
                        ...
                        <div class="col-lg-6 mb-4">
                            <div class="card shadow h-100 border-left-info">
                                ...
                                <div class="card-body">
                                    <form action="<?= BASE_URL ?>registrar_cambio_carrera" method="POST"
                                        id="form-cambio-carrera" class="needs-validation" novalidate>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 mb-3">
                                                ...
                                                <textarea class="form-control" id="motivo_cambio" name="motivo_cambio"
                                                    rows="4"
                                                    placeholder="Explique los motivos psicológicos/vocacionales del cambio..."></textarea>
                                                <div class="invalid-feedback" id="motivo_cambioError"></div>
                                                <small class="form-text text-muted">
                                                    Incluya aspectos psicológicos, vocacionales, intereses, aptitudes,
                                                    etc.
                                                </small>
                                                <div class="invalid-feedback" id="motivo_cambioError"></div>
                                            </div>
                                            ...
                                            <div class="col-12 mb-3">
                                                <label for="observaciones_cambio" class="form-label">Observaciones y
                                                    Recomendaciones</label>
                                                <textarea class="form-control" id="observaciones_cambio"
                                                    name="observaciones_cambio" rows="3"
                                                    placeholder="Recomendaciones, seguimiento, aspectos a considerar..."></textarea>
                                                <small class="form-text text-muted">
                                                    Recomendaciones vocacionales, aspectos a trabajar, pronóstico de
                                                    adaptación
                                                </small>
