            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="<?= BASE_URL ?>diagnostico_medicina_consultar"
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card shadow mb-4 border-left-primary">
                                ...
                                <div class="card-body">
                                    <form action="<?= BASE_URL ?>diagnostico_medicina_registrar" method="POST"
                                        id="form-consulta-medica" class="needs-validation" novalidate>
                                        ...
                                        <div class="row">
                                            <!-- Patología -->
                                            <div id="patologia-input" class="col-md-6 mb-3">
                                            ...
                                            <!-- Estatura y Peso -->
                                            <div id="antropometricos-input" class="col-md-6 mb-3">
                                                <h6 class="text-primary mb-3">
                                                    <i class="fas fa-ruler-vertical me-2"></i>Datos Antropométricos
                                                </h6>
                                                <div class="row">
                                                    <div class="col-md-6 mb-3">
                                                        <label for="estatura" class="form-label">Estatura (m) <span
                                        ...
                                        <div class="row">
                                            <!-- Tipo de sangre -->
                                            <div id="tipo-sangre-input" class="col-md-6 mb-3">
                                                <h6 class="text-primary mb-3">
                                                    <i class="fas fa-tint me-2"></i>Información Clínica
                                                </h6>
                                                <div class="mb-3">
                                                    <label for="tipo_sangre" class="form-label">Tipo de Sangre <span
                                                            class="text-danger">*</span></label>
                                                    <select name="tipo_sangre" id="tipo_sangre" class="form-select"
                                                        required>
                                                        <option value="" selected disabled>Seleccione tipo de sangre
                                                        </option>
                                            ...
                                            <!-- Motivo de visita -->
                                            <div id="motivo-visita-input" class="col-md-6 mb-3">
                                                <h6 class="text-primary mb-3">
                                                    <i class="fas fa-notes-medical me-2"></i>Motivo de Visita
                                                </h6>
                                                <div class="mb-3">
                                                    <label for="motivo_visita" class="form-label">Motivo <span
                                                            class="text-danger">*</span></label>
                                                    <textarea class="form-control" id="motivo_visita"
                                                        name="motivo_visita" rows="3"
                                        ...
                                        <div class="row">
                                            <!-- Diagnóstico -->
                                            <div id="diagnostico-input" class="col-md-6 mb-3">
                                                <h6 class="text-primary mb-3">
                                                    <i class="fas fa-file-medical me-2"></i>Diagnóstico
                                                </h6>
                                                <div class="mb-3">
                                                    <label for="diagnostico" class="form-label">Diagnóstico <span
                                                            class="text-danger">*</span></label>
                                                    <textarea class="form-control" id="diagnostico" name="diagnostico"
                                                        rows="4" placeholder="Describa el diagnóstico médico..."
                                                        required></textarea>
                                            ...
                                            <!-- Tratamiento -->
                                            <div id="tratamiento-input" class="col-md-6 mb-3">
                                                <h6 class="text-primary mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" id="tratamiento" name="tratamiento"
                                                        rows="4" placeholder="Describa el tratamiento recomendado..."
                                                        required></textarea>
                                        ...
                                        <div class="row">
                                            <!-- Observaciones -->
                                            <div id="observaciones-input" class="col-md-12 mb-3">
                                                <h6 class="text-primary mb-3">
                                        ...
                                        <div class="row">
                                            <!-- Insumos Utilizados -->
                                            <div id="insumos-input" class="col-md-12 mb-3">
                                                <h6 class="text-primary mb-3">
