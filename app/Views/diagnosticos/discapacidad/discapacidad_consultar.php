            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Gestionar Diagnósticos de Discapacidad</h1>
                    </div>
                        ...
                        <div class="col-lg-12 mb-4">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Diagnósticos de Discapacidad
                                        <i id="btn-ayuda" class="fa fa-question-circle float-right fa-lg"
                                            data-toggle="tooltip" title="Ayuda" style="cursor: pointer;"></i>
                                    </h6>
                                </div>
                                <div class="card-body">
                                    <table id="tabla_discapacidad" class="table table-striped table-bordered">
                                        <thead>
