            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="<?= BASE_URL ?>diagnostico_discapacidad_consultar"
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card shadow mb-4 border-left-primary">
                                ...
                                <div class="card-body">
                                    <form action="<?= BASE_URL ?>discapacidad_registrar" method="POST"
                                        id="form-discapacidad" class="needs-validation" novalidate>
                                        ...
                                        <div class="row">
                                            ...
                                            <div id="tipo-discapacidad-input" class="col-md-6 mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" id="tipo_discapacidad"
                                                    ...
                                                    <small class="form-text text-muted">Seleccione el tipo principal de
                                                        discapacidad.</small>
                                                </div>
                                            </div>

                                            <!-- Discapacidad Específica -->
                                            <div id="disc-especifica-input" class="col-md-6 mb-3">
                                                <h6 class="text-primary mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="disc_especifica"
                                                    ...
                                                    <small class="form-text text-muted">Especifique la discapacidad si
                                                        es necesario.</small>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <!-- Diagnóstico -->
                                            <div id="diagnostico-input" class="col-md-12 mb-3">
                                                <h6 class="text-primary mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <small class="form-text text-muted">Diagnóstico clínico formal según
                                                        CIE-10.</small>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <!-- Grado -->
                                            <div id="grado-input" class="col-md-6 mb-3">
                                                <h6 class="text-primary mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <small class="form-text text-muted">Nivel de afectación de la
                                                        discapacidad.</small>
                                                </div>
                                            </div>

                                            <!-- Medicamentos -->
                                            <div id="medicamentos-input" class="col-md-6 mb-3">
                                                <h6 class="text-primary mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <small class="form-text text-muted">Medicamentos, dosis y frecuencia
                                                        si es conocido.</small>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div id="habilidades-funcionales-input" class="col-md-6 mb-3">
                                                <h6 class="text-primary mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" id="habilidades_funcionales"
                                                        name="habilidades_funcionales" rows="3"
                                                        placeholder="Describa las habilidades funcionales del beneficiario..."
                                                        maxlength="255" required></textarea>
                                                    <div class="invalid-feedback" id="habilidades_funcionalesError">
                                                    </div>
                                                    <small class="form-text text-muted">Capacidades para realizar
                                                        actividades diarias.</small>
                                                </div>
                                            </div>

                                            <!-- Requiere Asistencia -->
                                            <div id="requiere-asistencia-input" class="col-md-6 mb-3">
                                                <h6 class="text-primary mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" id="requiere_asistencia"
                                                    ...
                                                    <small class="form-text text-muted">Indique si el beneficiario
                                                        necesita asistencia personal.</small>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div id="dispositivo-asistencia-input" class="col-md-6 mb-3">
                                                <h6 class="text-primary mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="dispositivo_asistencia"
                                                        name="dispositivo_asistencia"
                                                        placeholder="Ej: Silla de ruedas, audífonos, lentes, etc."
                                                        maxlength="255">
                                                    <div class="invalid-feedback" id="dispositivo_asistenciaError">
                                                    </div>
                                                    <small class="form-text text-muted">Dispositivos que utiliza el
                                                        beneficiario.</small>
                                                </div>
                                            </div>

                                            <!-- Carnet de Discapacidad -->
                                            <div id="carnet-discapacidad-input" class="col-md-6 mb-3">
                                                <h6 class="text-primary mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="carnet_discapacidad"
                                                        name="carnet_discapacidad"
                                                        placeholder="Número del carnet de discapacidad" maxlength="20">
                                                    <div class="invalid-feedback" id="carnet_discapacidadError"></div>
                                                    <small class="form-text text-muted">Número del carnet oficial si
                                                        posee.</small>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <!-- Observaciones -->
                                            <div id="observaciones-input" class="col-md-6 mb-3">
                                                <h6 class="text-primary mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <small class="form-text text-muted">Notas importantes, detalles
                                                        adicionales, etc.</small>
                                                </div>
                                            </div>

                                            <!-- Recomendaciones -->
                                            <div id="recomendaciones-input" class="col-md-6 mb-3">
                                                <h6 class="text-primary mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" id="recomendaciones"
                                                        name="recomendaciones" rows="4"
                                                        placeholder="Recomendaciones para el manejo, apoyos, adaptaciones, etc."></textarea>
                                                    <div class="invalid-feedback" id="recomendacionesError"></div>
                                                    <small class="form-text text-muted">Sugerencias para el
                                                        beneficiario, familia o institución.</small>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-12">
                                                <div class="d-flex justify-content-end gap-2">
                                                    <button type="button" class="btn btn-secondary"
                                                        id="limpiarFormularioDiscapacidad">
                                                        <i class="fas fa-times me-1"></i> Limpiar
                                                    </button>
                                                    <button type="submit" class="btn btn-primary">
                                                        <i class="fas fa-save me-1"></i> Guardar Diagnóstico de
                                                        Discapacidad
                                                    </button>
                                                </div>
                                            </div>
