                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <form action="<?= BASE_URL ?>registrar_insumo" method="POST" autocomplete="off"
                                            id="formulario-insumo">
                                            <div class="row">
                                                <!-- Nombre del Insumo -->
                                                <div id="div_nombre_insumo" class="col-md-6 mb-3">
                                                    <label for="nombre_insumo" class="form-label">Nombre del Insumo
                                                        <span class="text-danger">*</span></label>
                                                    <input type="text" name="nombre_insumo" id="nombre_insumo"
                                                        class="form-control" placeholder="Ej: Acetaminofén 500mg"
                                                        maxlength="100">
                                                    <div id="nombre_insumoError" class="form-text text-danger"></div>
                                                </div>

                                                <!-- Tipo de Insumo -->
                                                <div id="div_tipo_insumo" class="col-md-6 mb-3">
                                                    <label for="tipo_insumo" class="form-label">Tipo de Insumo <span
                                            ...
                                            <div class="row">
                                                <!-- Presentación -->
                                                <div id="div_presentacion" class="col-md-6 mb-3">
                                                    <label for="id_presentacion" class="form-label">Presentación <span
                                                            class="text-danger">*</span></label>
                                                    <select name="id_presentacion" id="id_presentacion"
                                                        ...
                                                        <?php foreach ($presentaciones as $presentacion): ?>
                                                            <option
                                                                value="<?= htmlspecialchars($presentacion['id_presentacion']) ?>">
                                                ...
                                                <div id="div_fecha_vencimiento" class="col-md-6 mb-3">
                                                    <label for="fecha_vencimiento" class="form-label">Fecha de
                                                        Vencimiento</label>
                                                    <input type="date" name="fecha_vencimiento" id="fecha_vencimiento"
                                                        class="form-control">
                                                    <div id="fecha_vencimientoError" class="form-text text-danger">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row" style="display: none;">
                                                <!-- Estatus -->
                                                <div id="div_estatus" class="col-md-6 mb-3">
                                                    <label for="estatus" class="form-label">Estatus <span
                                                            class="text-danger">*</span></label>
                                            ...
                                            <div class="row">
                                                <!-- Descripción -->
                                                <div id="div_descripcion" class="col-12 mb-3">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="d-flex justify-content-end gap-2">
                                                        ...
                                                        <button type="submit" id="btnRegistrarInsumo"
