...
class BeneficiarioModel extends BusinessModel
{
    ...
    public function manejarAccion($action)
    {
        switch ($action) {
            ...
            case 'verificar_duplicado':
                return $this->verificar_duplicado();
    ...
    private function validar_beneficiario_referencias()
    { //Validar si el beneficiario ha sido referido
        try {
    ...
    private function verificar_duplicado()
    {
        $campo = $this->__get('campo');
        $valor = $this->__get('valor');
