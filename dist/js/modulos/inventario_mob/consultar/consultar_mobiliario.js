$(function () {
    function inicializarDataTableMobiliario() {
        $('#tabla_mobiliario').DataTable({
            ajax: {
                url: 'mobiliario_data_json',
                dataSrc: ''
            },
            searching: true,
            layout: {
                topStart: {
                    buttons: [
                        ...
                        {
                            text: '<i class="fas fa-plus"></i> Crear Mobiliario',
    ...
    try {
        inicializarDataTableMobiliario();
    } catch (error) {
