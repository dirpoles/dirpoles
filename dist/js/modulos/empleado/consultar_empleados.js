      ...
      steps: [
        {
          ...
          popover: {
            ...
            description:
              "Exporta la tabla de empleados a un archivo Excel.",
            align: "center",
          },
        },
        {
          ...
          popover: {
            ...
            description: "Exporta la tabla de empleados a un archivo PDF.",
            align: "center",
          },
        },
        {
        ...
        {
          element: "#btn-horarios",
          popover: {
            title: "Horarios Psicólogos",
            description: "Consulta los horarios de los psicólogos.",
            align: "center",
          },
        },
        {
          element: "#tr-empleados",
          popover: {
            title: "Tabla de Empleados",
            description:
              "Tabla donde se muestran los empleados registrados.",
            align: "center",
          },
        },
        {
        ...
        },
        {
          ...
          popover: {
            ...
            description:
              "Elimina el empleado del sistema.",
            align: "center",
          },
        }
      ],
              ...
              },
              {
                ...
                customize: function (doc) {
                  ...
                  doc.content.push({
                    text:
                      "\n\nTotal de empleados: " +
                      (doc.content[2].table.body.length - 1),
                    alignment: "right",
                    fontSize: 10,
                    bold: true,
                    margin: [0, 20, 0, 0],
            ...
            render: function (data, type, row) {
              return `
                            <div class="btn-group" role="group">
                                <button id="btn-ver" class="btn btn-sm btn-primary btn-ver" data-id="${data}">
                                    <i class="fas fa-eye"></i>
                                </button>
                                <button id="btn-editar" class="btn btn-sm btn-info btn-editar" data-id="${data}">
                                    <i class="fas fa-edit"></i>
                                </button>
                                <button id="btn-eliminar" class="btn btn-sm btn-danger btn-eliminar" data-id="${data}">
    ...
    function editarEmpleado(id) {
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          tipos.forEach((tipo) => {
            const selected =
              tipo.id_tipo_emp == emp.id_tipo_empleado ? "selected" : "";
    ...
    function inicializarValidacionesEdicion(idEmpleado) {
      ...
      function validarNombre() {
        ...
        if (!regex.test(nombre)) {
          showError(
            elements.nombre,
            "El nombre solo debe contener letras y espacios, máximo 50 caracteres",
          );
          return false;
        }
      ...
      function validarApellido() {
        ...
        if (!regex.test(apellido)) {
          showError(
            elements.apellido,
            "El apellido solo debe contener letras y espacios, máximo 50 caracteres",
          );
          return false;
        }
      ...
      async function validarCorreo() {
        ...
        const correoRegex =
          /^[a-zA-Z0-9._%+-]+@(hotmail|yahoo|gmail|outlook|uptaeb)\.(com|es|net|org|edu|ve)$/i;
      ...
      function validarTipoEmpleado() {
        ...
        if (!id_tipo_empleado || id_tipo_empleado === "") {
          showError(
            elements.id_tipo_empleado,
            "El tipo de empleado es obligatorio",
          );
          return false;
        }
      ...
      function validarDireccion() {
        ...
        if (/^\s|\s$/.test(direccion)) {
          showError(
            elements.direccion,
            "La dirección no puede iniciar ni terminar con espacios",
          );
          return false;
        }
        ...
        if (direccion.length > 250) {
          showError(
            elements.direccion,
            "La dirección debe tener máximo 250 caracteres",
          );
          return false;
        }
        ...
        if (!regex.test(direccion)) {
          showError(
            elements.direccion,
            "La dirección solo puede contener letras, números, espacios, comas, puntos, guiones y #",
          );
          return false;
        }
      ...
      if (elements.fecha_nacimiento) {
        elements.fecha_nacimiento.addEventListener(
          "input",
