...
$(document).ready(function () {
  fetch("index.php?action=reportes_orientacion&data=1")
...
if (labelsP.length > 0) {
  chartP = new Chart(document.getElementById("chartP").getContext("2d"), {
    ...
    plugins: [ChartDataLabels],
            ...
            // No hay datos para mostrar en el gráfico de PNF
