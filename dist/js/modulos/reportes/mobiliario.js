          ...
          steps: [
            {
              ...
              popover: {
                ...
                description:
                  "Selecciona el tipo de reporte que deseas generar: Mobiliario o Equipos.",
                align: "center",
              },
            },
            {
            ...
            },
            {
              ...
              popover: {
                title: "Tipo",
                description:
                  "Filtra los resultados por tipo de mobiliario o equipo.",
                align: "center",
              },
            },
            {
              ...
              popover: {
                title: "Ubicación",
                description:
                  "Filtra los resultados por ubicación del mobiliario o equipo.",
                align: "center",
              },
            },
            {
              ...
              popover: {
                title: "Marca",
                description:
                  "Filtra los resultados por marca del mobiliario o equipo.",
                align: "center",
              },
            },
            {
              ...
              popover: {
                title: "Modelo",
                description:
                  "Filtra los resultados por modelo del mobiliario o equipo.",
                align: "center",
              },
            },
            {
              ...
              popover: {
                title: "Estado",
                description:
                  "Filtra los resultados por estado del mobiliario o equipo.",
                align: "center",
              },
            },
          ],
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document
    ...
    .addEventListener("change", function () {
      ...
      document.getElementById("divSerial").style.display =
        cat === "equipos" ? "block" : "none";
  ...
  document
    .getElementById("sel-grafica-mob")
    .addEventListener("change", () => actualizarVisibilidadCharts("mob"));
  document
    .getElementById("sel-tipo-chart-mob")
    .addEventListener("change", function () {
  ...
  document
    .getElementById("sel-grafica-eq")
    .addEventListener("change", () => actualizarVisibilidadCharts("eq"));
  document
    .getElementById("sel-tipo-chart-eq")
    .addEventListener("change", function () {
      currentType = this.value;
  ...
  fetch(BASE_URL + "reportes_mobiliario_data")
    ...
    .catch((err) => {
      ...
      Swal.fire({
        icon: "error",
        title: "Error",
        text: "No se pudo cargar la data del inventario.",
      });
    });
}
...
function poblarFiltrosDinamicos(cat) {
  ...
  if (f.servicio)
    f.servicio.forEach((s) => {
      const o = document.createElement("option");
      o.value = s.nombre_serv;
      o.textContent = s.nombre_serv;
    ...
    if (f.serial)
      f.serial.forEach((s) => {
        if (s.serial) {
          const o = document.createElement("option");
          o.value = s.serial;
          o.textContent = s.serial;
          selSerial.appendChild(o);
        }
      });
  }
}
...
function renderCharts(cat, data) {
  ...
  c.T = new Chart(
    document.getElementById(`chart${prefix}T`).getContext("2d"),
    config("Tipo", dT.labels, dT.values),
  );
  c.MA = new Chart(
    document.getElementById(`chart${prefix}MA`).getContext("2d"),
    config("Marca", dMA.labels, dMA.values),
  );
  c.E = new Chart(
    document.getElementById(`chart${prefix}E`).getContext("2d"),
    config("Estado", dE.labels, dE.values),
  );
  c.U = new Chart(
    document.getElementById(`chart${prefix}U`).getContext("2d"),
...
function actualizarVisibilidadCharts(cat) {
  ...
  if (v === "todos")
    ...
    document.getElementById(`w-chart${prefix}T`).style.display = "";
  else if (v === "marca")
    document.getElementById(`w-chart${prefix}MA`).style.display = "";
  else if (v === "estado")
    document.getElementById(`w-chart${prefix}E`).style.display = "";
  else if (v === "ubicacion")
    document.getElementById(`w-chart${prefix}U`).style.display = "";
}
