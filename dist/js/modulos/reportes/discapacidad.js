          ...
          steps: [
            ...
            },
            {
              ...
              popover: {
                title: "PNF",
                description:
                  "Filtra los resultados por Programa Nacional de Formación del paciente.",
                align: "center",
              },
            },
            {
              ...
              popover: {
                title: "Área",
                description:
                  "Filtra los resultados por área de atención o servicio.",
                align: "center",
              },
            },
          ],
...
function poblarSelects(data) {
  ...
  const areas = [
    ...new Set(data.map((i) => i.area_especializacion).filter(Boolean)),
  ]; // Asumiendo que existe en el objeto si se usa

  pnfs.forEach((p) => {
    const opt = document.createElement("option");
    opt.value = p;
    opt.textContent = p;
    pnfSel.appendChild(opt);
  });
...
function renderCharts(data) {
  ...
  charts.G = new Chart(
    ...
    buildConfig(currentChartType, gData.labels, gData.values, "Por Género"),
  );
  charts.P = new Chart(
    document.getElementById("chartP").getContext("2d"),
    buildConfig(currentChartType, pData.labels, pData.values, "Por PNF"),
  );
}
      ...
      },
      {
        ...
        customize: function (doc) {
          ...
          const visibleCharts = [
            {
              id: "chartG",
              wrapper: "wrapper-chartG",
              title: "Distribución por Género",
            },
            {
              id: "chartP",
              wrapper: "wrapper-chartP",
              title: "Distribución por PNF",
            },
          ];
