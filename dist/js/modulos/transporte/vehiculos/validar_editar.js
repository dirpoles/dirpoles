function inicializarValidacionesEditarVehiculo() {
    ...
    function validarPlaca() {
        ...
        const id_vehiculo = document.getElementById('id_vehiculo') ? document.getElementById('id_vehiculo').value : '';
        ...
        return new Promise((resolve) => {
            fetch("vehiculos_validar_placa", {
                ...
                body: `placa=${placa}&id_vehiculo=${id_vehiculo}`
            })
...
async function enviarFormularioVehiculo(form) {
    try {
        ...
        const response = await fetch('vehiculo_actualizar', {
            method: 'POST',
            body: formData,
            headers: {
        ...
        if (data.exito || data.success) {
            AlertManager.success('Exito', data.mensaje || 'Vehículo actualizado correctamente.');
            ...
            AlertManager.error('Error', data.mensaje || 'No se pudo actualizar el vehículo.');
        }
