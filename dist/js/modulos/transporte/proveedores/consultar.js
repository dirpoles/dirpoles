            ...
            render: function (data, type, row) {
                return `
                            <div class="btn-group btn-group-sm" role="group">
                                <button id="btnVerPR" class="btn btn-primary btn-ver" 
                                        data-id="${data}"
                                        data-bs-toggle="tooltip"
                                        title="Ver detalles">
                                    <i class="fas fa-eye"></i>
                                </button>
                                <button id="btnEditarPR" class="btn btn-info btn-editar" 
                                        data-id="${data}"
                                        data-bs-toggle="tooltip"
                                        title="Editar proveedor">
                                    <i class="fas fa-edit"></i>
                                </button>
                                <button id="btnEliminarPR" class="btn btn-danger btn-eliminar" 
                                        data-id="${data}"
                                        data-bs-toggle="tooltip"
