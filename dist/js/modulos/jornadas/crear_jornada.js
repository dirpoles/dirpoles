window.onload = function () {
  addEventListener("click", function (e) {
    ...
    const driverObj = window.driver.js.driver({
      ...
      steps: [
        {
          element: "#input_nombre_jornada",
          popover: {
            title: "Nombre de la Jornada",
            description:
              "Ingresa un nombre descriptivo para la jornada.",
            align: "center",
          },
        },
        {
          element: "#input_tipo_jornada",
          popover: {
            title: "Tipo de Jornada",
            description:
              "Selecciona o escribe el tipo de jornada: Médica Integral, Vacunación, Odontológica, Pediátrica, Asistencia Social, u otro.",
            align: "center",
          },
        },
        {
          ...
          popover: {
            ...
            description:
              "Indica el lugar exacto donde se realizará la jornada.",
            align: "center",
          },
        },
        {
          element: "#input_aforo_maximo",
          popover: {
            title: "Aforo Máximo",
            description:
              "Especifica el número máximo de personas que pueden participar o ser atendidas durante la jornada.",
            align: "center",
          },
        },
        {
          element: "#input_fecha_inicio",
          popover: {
            title: "Fecha y Hora de Inicio",
            description:
              "Selecciona la fecha y hora en que dará inicio la jornada.",
            align: "center",
          },
        },
        {
          element: "#input_fecha_fin",
          popover: {
            title: "Fecha y Hora de Fin",
            description:
              "Selecciona la fecha y hora en que finalizará la jornada. Ambas son obligatorias y deben ser posteriores a la fecha de inicio.",
            align: "center",
          },
        },
        {
          ...
          popover: {
            title: "Descripción del Operativo",
            description:
              "Detalla los servicios médicos que se ofrecerán, requerimientos especiales, personal necesario, materiales requeridos y cualquier información relevante.",
            side: "top",
            align: "center",
          },
        },
  ...
  function syncHiddenDates() {
    const start = buildDateTime(
      elements.fecha_inicio_date.value,
      elements.fecha_inicio_time.value,
    );
    const end = buildDateTime(
      elements.fecha_fin_date.value,
      elements.fecha_fin_time.value,
    );
  ...
  function validarNombreJornada() {
    ...
    if (nombre_jornada.length < 5) {
      showError(
        elements.nombre_jornada,
        "El nombre de la jornada debe tener al menos 5 caracteres",
      );
      return false;
    }
    ...
    if (nombre_jornada.length > 100) {
      showError(
        elements.nombre_jornada,
        "El nombre de la jornada no debe exceder los 100 caracteres",
      );
      return false;
    }
    ...
    if (!regex.test(nombre_jornada)) {
      showError(
        elements.nombre_jornada,
        "El nombre de la jornada solo puede contener letras y espacios",
      );
      return false;
    }
  ...
  function validarTipoJornada() {
    ...
    if (tipo_jornada.length < 5) {
      showError(
        elements.tipo_jornada,
        "El tipo de jornada debe tener al menos 5 caracteres",
      );
      return false;
    }
    ...
    if (tipo_jornada.length > 100) {
      showError(
        elements.tipo_jornada,
        "El tipo de jornada no debe exceder los 100 caracteres",
      );
      return false;
    }
    ...
    if (!regex.test(tipo_jornada)) {
      showError(
        elements.tipo_jornada,
        "El tipo de jornada solo puede contener letras y espacios",
      );
      return false;
    }
  ...
  function validarUbicacion() {
    ...
    if (ubicacion.length > 100) {
      showError(
        elements.ubicacion,
        "La ubicacion no debe exceder los 100 caracteres",
      );
      return false;
    }
    ...
    if (!regex.test(ubicacion)) {
      showError(
        elements.ubicacion,
        "La ubicacion solo puede contener letras, numeros, espacios y simbolos . , # -",
      );
      return false;
    }
  ...
  function validarAforoMaximo() {
    ...
    if (aforo_maximo.length < 1) {
      showError(
        elements.aforo_maximo,
        "El aforo maximo debe tener al menos 1 digito",
      );
      return false;
    }
    ...
    if (valorAforo > 500) {
      showError(
        elements.aforo_maximo,
        "El aforo maximo no debe exceder las 500 personas",
      );
      return false;
    }
    ...
    if (!regex.test(aforo_maximo)) {
      showError(
        elements.aforo_maximo,
        "El aforo maximo solo puede contener numeros",
      );
      return false;
    }
