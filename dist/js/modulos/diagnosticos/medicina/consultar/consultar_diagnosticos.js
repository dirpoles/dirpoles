...
$(function () {
    function inicializarDataTableGeneral() {
        $('#tabla_medicina').DataTable({
            ajax: {
                url: 'diagnostico_medicina_data_json',
                dataSrc: 'data'
            },
            searching: true,
            layout: {
                topStart: {
                    buttons: [
                        ...
                        },
                        {
                            ...
                            action: function () {
                                window.location.href = 'diagnostico_medicina';
                            }
                        }
                    ]
                },
    ...
    function asignarEventosBotones() {
        ...
        $(document).on('click', '.btn-eliminar', function () {
            ...
            const idDetalle = $(this).data('id-detalle-patologia');
            const idBeneficiario = $(this).data('id-beneficiario');
            if (typeof eliminarDiagnostico !== 'undefined') {
                eliminarDiagnostico(id, idSolicitud, idDetalle, idBeneficiario);
            } else {
