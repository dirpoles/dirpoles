window.onload = function () {
  ...
  function inicializarDataTableBeneficiarios() {
    $("#tablaBeneficiariosModal").DataTable({
      ...
      initComplete: function () {
        $(document)
          .off("click", ".btn-seleccionar-beneficiario")
          .on("click", ".btn-seleccionar-beneficiario", function () {
  ...
  function validarDiagnostico() {
    ...
    if (diagnostico.length < 5) {
      showError(
        elements.diagnostico,
        "El diagnóstico debe tener al menos 5 caracteres",
      );
      return false;
    }
  ...
  function validarTratamiento() {
    ...
    if (tratamiento.length < 5) {
      showError(
        elements.tratamiento,
        "El tratamiento debe tener al menos 5 caracteres",
      );
      return false;
    }
