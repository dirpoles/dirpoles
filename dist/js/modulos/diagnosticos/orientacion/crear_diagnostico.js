window.onload = function () {
      ...
      steps: [
        {
          ...
          popover: {
            title: "Beneficiario",
            description:
              "Selecciona el beneficiario al cual se le asignará el diagnostico.",
            align: "center",
          },
        },
        {
          element: "#motivo-orientacion-input",
          popover: {
            title: "Motivo de Orientación",
            description:
              "Describe el motivo principal por el cual el beneficiario requiere orientación.",
            align: "center",
          },
        },
        {
          element: "#descripcion-orientacion-input",
          popover: {
            title: "Descripción de la Sesión",
            description:
              "Detalla el desarrollo de la sesión, aspectos relevantes discutidos y emociones expresadas.",
            align: "center",
          },
        },
        {
          element: "#indicaciones-orientacion-input",
          popover: {
            title: "Indicaciones",
            description:
              "Especifica las actividades, tareas o recomendaciones para el beneficiario.",
            align: "center",
          },
        },
        {
          element: "#obs-adic-orientacion-input",
          popover: {
            title: "Observaciones Adicionales",
            description:
              "Agrega notas adicionales, impresiones del psicólogo o sugerencias para próximas sesiones.",
            align: "center",
          },
        },
      ],
  ...
  const elements = {
    ...
    indicaciones_orientacion: document.getElementById(
  ...
  function validarMotivoOrientacion() {
    ...
    if (motivo_orientacion === "") {
      showError(
        elements.motivo_orientacion,
        "El motivo de orientación es obligatorio",
      );
      return false;
    }
    ...
    if (/^\s|\s$/.test(motivo_orientacion)) {
      showError(
        elements.motivo_orientacion,
        "El motivo de orientación no puede comenzar ni terminar con espacios",
      );
      return false;
    }
    ...
    if (motivo_orientacion.length < 5) {
      showError(
        elements.motivo_orientacion,
        "El motivo de orientación debe tener al menos 5 caracteres",
      );
      return false;
    }
    ...
    if (motivo_orientacion.length > 250) {
      showError(
        elements.motivo_orientacion,
        "El motivo de orientación debe tener menos de 250 caracteres",
      );
      return false;
    }
    ...
    if (!regex.test(motivo_orientacion)) {
      showError(
        elements.motivo_orientacion,
        "El motivo de orientación solo puede contener letras, números, espacios, comas, puntos guiones y #",
      );
      return false;
    }
  ...
  function validarDescripcionOrientacion() {
    ...
    if (descripcion_orientacion === "") {
      showError(
        elements.descripcion_orientacion,
        "La descripción de orientación es obligatoria",
      );
      return false;
    }
    ...
    if (/^\s|\s$/.test(descripcion_orientacion)) {
      showError(
        elements.descripcion_orientacion,
        "La descripción de orientación no puede comenzar ni terminar con espacios",
      );
      return false;
    }
    ...
    if (descripcion_orientacion.length < 5) {
      showError(
        elements.descripcion_orientacion,
        "La descripción de orientación debe tener al menos 5 caracteres",
      );
      return false;
    }
    ...
    if (descripcion_orientacion.length > 250) {
      showError(
        elements.descripcion_orientacion,
        "La descripción de orientación debe tener menos de 250 caracteres",
      );
      return false;
    }
    ...
    if (!regex.test(descripcion_orientacion)) {
      showError(
        elements.descripcion_orientacion,
        "La descripción de orientación solo puede contener letras, números, espacios, comas, puntos guiones y #",
      );
      return false;
    }
  ...
  function validarIndicacionesOrientacion() {
    ...
    indicaciones_orientacion = indicaciones_orientacion.replace(
      /<[^>]*>?/gm,
      "",
    );
    ...
    if (indicaciones_orientacion === "") {
      showError(
        elements.indicaciones_orientacion,
        "Las indicaciones de orientación son obligatorias",
      );
      return false;
    }
    ...
    if (/^\s|\s$/.test(indicaciones_orientacion)) {
      showError(
        elements.indicaciones_orientacion,
        "Las indicaciones de orientación no pueden comenzar ni terminar con espacios",
      );
      return false;
    }
    ...
    if (indicaciones_orientacion.length < 5) {
      showError(
        elements.indicaciones_orientacion,
        "Las indicaciones de orientación debe tener al menos 5 caracteres",
      );
      return false;
    }
    ...
    if (indicaciones_orientacion.length > 250) {
      showError(
        elements.indicaciones_orientacion,
        "Las indicaciones de orientación debe tener menos de 250 caracteres",
      );
      return false;
    }
    ...
    if (!regex.test(indicaciones_orientacion)) {
      showError(
        elements.indicaciones_orientacion,
        "Las indicaciones de orientación solo puede contener letras, números, espacios, comas, puntos guiones y #",
      );
      return false;
    }
  ...
  function validarObservaciones() {
    ...
    if (/^\s|\s$/.test(obs_adic_orientacion)) {
      showError(
        elements.obs_adic_orientacion,
        "Las observaciones adicionales no pueden comenzar ni terminar con espacios",
      );
      return false;
    }
    ...
    if (obs_adic_orientacion.length < 5) {
      showError(
        elements.obs_adic_orientacion,
        "Las observaciones adicionales debe tener al menos 5 caracteres",
      );
      return false;
    }
    ...
    if (obs_adic_orientacion.length > 250) {
      showError(
        elements.obs_adic_orientacion,
        "Las observaciones adicionales debe tener menos de 250 caracteres",
      );
      return false;
    }
    ...
    if (!regex.test(obs_adic_orientacion)) {
      showError(
        elements.obs_adic_orientacion,
        "Las observaciones adicionales solo puede contener letras, números, espacios, comas, puntos guiones y #",
      );
      return false;
    }
  ...
  elements.motivo_orientacion.addEventListener(
    "input",
    validarMotivoOrientacion,
  );
  elements.descripcion_orientacion.addEventListener(
    "input",
    validarDescripcionOrientacion,
  );
  elements.indicaciones_orientacion.addEventListener(
    "input",
