...
$(function () {
    function inicializarDataTableGeneral() {
        $('#tabla_diagnostico_general').DataTable({
            ajax: {
                url: 'diagnostico_general_data_json',
                dataSrc: 'data'
            },
            searching: true,
            layout: {
                topStart: {
                    buttons: [
                        ...
                        },
                        {
                            ...
                            action: function () {
                                window.location.href = 'diagnostico_psicologia';
                            }
                        }
                    ]
                },
    ...
    function asignarEventosBotones() {
        ...
        $(document).on('click', '.btn-constancia', function () {
            ...
            window.open(`generar_constancia_psicologia?id_psicologia=${id}`, '_blank');
        });

        $(document).on('click', '.btn-referencia', function () {
            const id = $(this).data('id');
            window.open(`generar_referencia_psicologia?id_psicologia=${id}`, '_blank');
        });
        ...
        $(document).on('click', '.btn-eliminar', function () {
            ...
            if (typeof eliminarDiagnostico !== 'undefined') {
                eliminarDiagnostico(id, idSolicitud);
            } else {
