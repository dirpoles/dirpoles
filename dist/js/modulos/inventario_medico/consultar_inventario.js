$(function () {
  ...
  window.mostrarEntrada = function () {
    ...
    if (typeof inicializarValidacionEntrada === "function") {
      ...
      console.error(
        "La función inicializarValidacionEntrada no está definida en validar_entrada.js",
      );
    }
  };
  ...
  window.mostrarSalida = function () {
    ...
    if (typeof inicializarValidacionSalida === "function") {
      ...
      console.error(
        "La función inicializarValidacionSalida no está definida en validar_salida.js",
      );
    }
  };
  ...
  document.addEventListener("click", function (e) {
    ...
    const driverObj = window.driver.js.driver({
      ...
      steps: [
        ...
        {
          element: "#btn-ci", // Crear Insumo
          popover: {
            title: "Crear Nuevo Insumo",
            description:
              "Abre el formulario para agregar un nuevo insumo al inventario. Completa todos los campos requeridos.",
            side: "bottom",
            align: "center",
          }
        },
        {
          element: "#btn-cm", // Consultar Movimientos
          popover: {
            title: "Consultar Movimientos",
            description:
              "Visualiza el historial completo de entradas y salidas de insumos. Filtra por fechas si es necesario.",
            side: "bottom",
            align: "center",
          }
        },
        {
          element: "#btn-re", // Registrar Entrada
          popover: {
            title: "Registrar Entrada",
            description:
              "Aumenta el stock de insumos existentes registrando una nueva entrada. Indica cantidad y fecha.",
            side: "bottom",
            align: "center",
          }
        },
        {
          element: "#btn-rs", // Registrar Salida
          popover: {
            title: "Registrar Salida",
            description:
              "Registra el consumo, uso o salida de insumos del inventario. Especifica la cantidad y el motivo.",
            side: "bottom",
            align: "center",
          }
        },
        {
          element: "#tr-insumos", // Registrar Salida
          popover: {
            title: "Informacion de la tabla",
            description:
              "Informacion de la tabla de insumos.",
            side: "top",
            align: "center",
          }
        },
        {
          ...
          popover: {
            title: "Ver Insumo",
            description:
              "Visualiza la informacion del insumo.",
            side: "right",
            align: "center",
          }
        },
        {
          ...
          popover: {
            title: "Editar Insumo",
            description:
              "Edita la informacion del insumo.",
            side: "right",
            align: "center",
          }
        },
        {
          ...
          popover: {
            ...
            description:
              "Elimina el insumo del inventario.",
            side: "right",
            align: "center",
          }
        }
