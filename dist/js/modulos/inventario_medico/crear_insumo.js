window.onload = function () {
  document.getElementById("btn-ayuda").addEventListener("click", function () {
    const driverObj = window.driver.js.driver({
      ...
      steps: [
        {
          element: "#div_nombre_insumo",
          popover: {
            title: "Nombre del Insumo",
            description:
              "Ingresa el nombre completo del insumo. Ejemplo: Acetaminofén 500mg. Este campo es obligatorio.",
            align: "center",
          }
        },
        {
          element: "#div_tipo_insumo",
          popover: {
            title: "Tipo de Insumo",
            description:
              "Selecciona el tipo de insumo: Medicamento, Material o Quirúrgico. Este campo es obligatorio.",
            align: "center",
          }
        },
        {
          element: "#div_presentacion",
          popover: {
            title: "Presentación",
            description:
              "Selecciona la presentación del insumo (tabletas, frascos, cajas, etc.). Este campo es obligatorio.",
            align: "center",
          }
        },
        {
          element: "#div_fecha_vencimiento",
          popover: {
            title: "Fecha de Vencimiento",
            description:
              "Selecciona la fecha de vencimiento del insumo si corresponde. No es obligatorio.",
            align: "center",
          }
        },
        {
          element: "#div_descripcion",
          popover: {
            title: "Descripción",
            description:
              "Proporciona una descripción detallada del insumo. Incluye información relevante como dosis, composición, o instrucciones de uso. Este campo es obligatorio.",
            align: "center",
          }
        }
      ]
  ...
  function validarNombreInsumo() {
    ...
    if (nombre.length > 50) {
      showError(
        ...
        "El nombre del insumo no puede superar los 50 caracteres",
      );
      return false;
    }
  ...
  // Fecha
  elements.fecha_vencimiento.addEventListener(
    "change",
